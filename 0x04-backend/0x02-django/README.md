## INTRODUCTION TO DJANGO + DJANGO REST FRAMEWORK
...
2. **Install Django Project:**
    ...
    pip install Pillow 
    django-admin startproject weatherapi . #include the dot at the end
    # update settings.py
...
3. **Setup Database, createsuperuser, makemigrations and collectstatics**
    ...
    # create folder static(css, js, files), templates(*.html files) collect static files
...
6. **Update weatherapi settings.py**
